...
trait RepositoryTrait
{
    ...
    public function updateWithRedirect($id, Request $request, $redirectToAction = null, $callback = null)
    {
        ...
        return $this->createRedirectObjectWithSuccess("Uloženo", $object, $redirectToAction);
    }
    ...
    public function createWithRedirect(Request $request, $redirectToAction = null)
    {
        ...
        return $this->createRedirectObjectWithSuccess("Vytvořeno", $object, $redirectToAction);
    }
    ...
    {
        $this->deleteByKey($id);
        return $this->createRedirectObjectWithSuccess("Smazáno", null, $redirectToAction);
    }
